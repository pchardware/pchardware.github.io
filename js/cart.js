...
function addCartItem($container, item, product) {
    ...
    divElement.addEventListener("click", () => removeCartItem(product.slug, $(trElement)));

    let imgElement = document.createElement("img");
    imgElement.setAttribute("src", "./images/products/" + product.slug + "-1.jpg");
...
function removeCartItem(productSlug, $trElement) {
    let cart = getCart();    
